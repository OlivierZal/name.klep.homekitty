    ...
    HeatingCoolingState : {
          ...
          const currentValue = value !== 'auto'
            ...
            : currentTemperature < targetTemperature
              ...
              : currentTemperature > targetTemperature
                ? 'COOL'
                : 'OFF';
          if (currentValue in Characteristic.CurrentHeatingCoolingState) {
      ...
      Target : {
        get : value => {
          ...
          if (targetValue in Characteristic.TargetHeatingCoolingState) {
            return Characteristic.TargetHeatingCoolingState[targetValue];
          }
          return Characteristic.TargetHeatingCoolingState.OFF;
        },
        set : value => [ 'off', 'heat', 'cool', 'auto' ][value] ?? 'off',
      }
    },
    TiltAngle: {
